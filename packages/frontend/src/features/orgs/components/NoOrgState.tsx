...
export const NoOrgState: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-6 bg-bg-page">
      ...
      <div className="flex gap-3">
        <button
          ...
          className="flex h-11 items-center border border-border px-6 font-mono text-[11px] font-bold uppercase tracking-wide text-white hover:border-border-light hover:bg-bg-subtle"
        >
          JOIN ORGANIZATION
        </button>
        <button
