...
const LandingPage: React.FC = () => {
  return (
    <div className="flex min-h-screen flex-col bg-bg-page">
      ...
      {/* Hero Section */}
      <section className="flex flex-1 flex-col items-center gap-8 px-4 pb-16 pt-14 sm:gap-10 sm:px-8 sm:pt-20 lg:px-[120px] lg:pb-[100px] lg:pt-[120px]">
        {/* Badge */}
        ...
        {/* Headline */}
        <h1 className="max-w-[900px] text-center font-display text-[40px] font-bold leading-[1.1] tracking-[-1px] text-white sm:text-[52px] sm:tracking-[-1.5px] lg:text-[64px] lg:tracking-[-2px]">
        ...
        {/* Subline */}
        <p className="max-w-[700px] text-center font-mono text-[14px] font-normal leading-[1.6] text-gray-500 sm:text-[15px]">
